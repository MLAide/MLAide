...
import { of } from 'rxjs';
import { ModelRevision } from 'src/app/core/models/artifact.model';
    ...
    describe('model log table', () => {
      ...
      describe('close button', () => {
        it('should have close button', async () => {
          ...
          const closeButton: MatButtonHarness = await loader.getHarness(MatButtonHarness.with({ selector: '#model-stage-close-button' }));
