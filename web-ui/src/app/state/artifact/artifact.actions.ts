...
export const loadArtifactsSucceeded = createAction(
  "@mlaide/actions/artifacts/load/succeeded",
...
export const loadArtifactsOfCurrentRunSucceeded = createAction(
  "@mlaide/actions/artifacts-of-current-run/load/succeeded",
  props<{ artifacts: Artifact[] }>()
);
export const loadArtifactsOfCurrentRunFailed = createAction(
  "@mlaide/actions/artifacts-of-current-run/load/failed",
  props<{ payload: any }>()
);

export const editModel = createAction(
  "@mlaide/actions/models/edit",
  props<{ modelName: string; note: string; stage: ModelStage; version: number }>()
);
...
export const openModelStageLogDialog = createAction(
  "@mlaide/actions/models/stage-log-dialog/open",
  props<{ modelRevisions: ModelRevision[] }>()
);
...
export const downloadArtifact = createAction(
  "@mlaide/actions/artifacts/download",
  props<{ projectKey: string; artifactName: string; artifactVersion: number; artifactFileId?: string }>()
);
export const downloadArtifactSucceeded = createAction(
  "@mlaide/actions/artifacts/download/succeeded",
