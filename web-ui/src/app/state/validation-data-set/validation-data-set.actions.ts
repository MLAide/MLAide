...
import {
  AddValidationDataSetAndUploadFilesResult,
  FileHash,
  ValidationDataSet
...
export const addValidationDataSetWithFilesSucceeded = createAction("@mlaide/actions/validation-data-set/find/by-file-hashes/succeeded", props<{ addValidationDataSetAndUploadFilesResult: AddValidationDataSetAndUploadFilesResult }>());
