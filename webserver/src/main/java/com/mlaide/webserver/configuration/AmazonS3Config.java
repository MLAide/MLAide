...
public class AmazonS3Config {
    @Value("${mlaide.object-storage.endpoint}")
    private String s3Endpoint;

    @Value("${mlaide.object-storage.region}")
    private String s3Region;

    @Value("${mlaide.object-storage.credentials.access-key}")
    private String s3accessKey;

    @Value("${mlaide.object-storage.credentials.secret-key}")
